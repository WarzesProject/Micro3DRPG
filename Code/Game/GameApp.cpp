...
bool GameApp::Init()
{
	...
	Renderer::IRendererPtr renderer(Game::Get().mRenderer);
	if (nullptr != renderer)
	{
...
#include "Basics/FirstTriangle/FirstTriangle_GLSL_450.h"
#include "Basics/FirstTriangle/FirstTriangle_GLSL_410.h"
#include "Basics/FirstTriangle/FirstTriangle_GLSL_ES3.h"
#include "Basics/FirstTriangle/FirstTriangle_HLSL_D3D9_D3D10_D3D11_D3D12.h"
#include "Basics/FirstTriangle/FirstTriangle_Null.h"
			...
			{
				mGraphicsPipelineState = renderer->createGraphicsPipelineState(Renderer::GraphicsPipelineStateBuilder(mRootSignature, graphicsProgram, vertexAttributes, Game::Get().mMainSwapChain->getRenderPass()));
...
bool GameApp::DoesCompleteOwnDrawing()
{
	return false;
}

void GameApp::fillCommandBuffer()
{
	// Sanity checks
