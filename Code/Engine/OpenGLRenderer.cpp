...
#include <OpenGL/GL/glext.h>	// Requires definitions from "gl.h"
#include <OpenGL/GL/wglext.h>	// Requires definitions from "gl.h"
PRAGMA_WARNING_POP
...
namespace
{
	namespace detail
	{
		...
		*/
		// TODO(co) Visual Studio 2017 compile settings: For some reasons I need to disable optimization for the following method or else "glslang::TShader::parse()" will output the error "ERROR: 0:1: 'ˆ' : unexpected token" (glslang (latest commit c325f4364666eedb94c20a13670df058a38a14ab - April 20, 2018), Visual Studio 2017 15.7.1)
#ifdef _MSC_VER
#pragma optimize("", off)
#endif
