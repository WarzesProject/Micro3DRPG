...
#include "Resource/MaterialBlueprint/Loader/MaterialBlueprintResourceLoader.h"
	...
	void MaterialBlueprintResourceManager::update()
	{
		...
		{ // Set previous global time in seconds
			...
			mGlobalMaterialProperties.setPropertyById(
				...
				(nullptr != materialProperty) ? *((MaterialPropertyValue*)materialProperty) : MaterialPropertyValue::fromFloat(timeManager.getGlobalTimeInSeconds()),
